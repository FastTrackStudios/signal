    ...
    for module in modules {
        ...
        for block in module.blocks {
            ...
            if !mappings.is_empty() {
                vm = vm.with_block(
                    VirtualBlock::new(block.id, block.label, block.block_type)
                        .with_params(mappings),
                );
            }
        }
...
const PETRUCCI_RAW: &str = include_str!("ndsp_inventory/vst3-archetype-petrucci-x-neural-dsp.txt");
...
const JOHN_MAYER_MODULES: &[ModuleSpec] = &[
    ...
    ModuleSpec {
        ...
        blocks: &[
            ...
            BlockSpec {
                ...
                exact: &[],
                prefixes: &["Justa Boost "],
            },
            BlockSpec {
                id: "antelope-filter",
                label: "Antelope Filter",
                block_type: BlockType::Filter,
                exact: &[],
                prefixes: &["Antelope Filter "],
            },
            BlockSpec {
                id: "halfman-od",
                label: "Halfman OD",
            ...
            BlockSpec {
                ...
                block_type: BlockType::Drive,
                exact: &[],
                prefixes: &["Tealbreaker "],
            },
            BlockSpec {
                id: "millipede-delay",
                label: "Millipede Delay",
                block_type: BlockType::Delay,
                exact: &[],
                prefixes: &["Millipede Delay "],
            },
        ],
    },
    ModuleSpec {
        ...
        blocks: &[
            BlockSpec {
                id: "gravity-tank-section",
                label: "Gravity Tank Section",
                block_type: BlockType::Special,
                exact: &["Active Gravity Tank Section"],
                prefixes: &[],
            },
            BlockSpec {
                id: "spring-reverb",
    ...
    ModuleSpec {
        ...
        blocks: &[
            ...
            BlockSpec {
                id: "smooth-operator-amp",
                label: "Smooth Operator",
                block_type: BlockType::Amp,
                exact: &[],
                prefixes: &["Smooth Operator "],
            },
            BlockSpec {
                id: "headroom-hero-amp",
                label: "Headroom Hero",
                block_type: BlockType::Amp,
                exact: &[],
                prefixes: &["Headroom Hero "],
            },
            BlockSpec {
                id: "signature-83-amp",
                label: "Signature 83",
                block_type: BlockType::Amp,
                exact: &[],
                prefixes: &["Signature 83 "],
            },
            BlockSpec {
                id: "three-in-one-amp",
                label: "Three-In-One Amp",
                block_type: BlockType::Amp,
                exact: &[],
                prefixes: &["Three-In-One Amp "],
            },
        ],
    },
    ModuleSpec {
        ...
        blocks: &[
            ...
            BlockSpec {
                ...
                prefixes: &[
                    "Cab L ",
                    "Cab Smooth Operator L Mic Type",
                    "Cab Headroom Hero L Mic Type",
                    "Cab Signature 83 L Mic Type",
                ],
            },
            BlockSpec {
                id: "room-left",
            ...
            BlockSpec {
                ...
                prefixes: &[
                    "Cab R ",
                    "Cab Smooth Operator R Mic Type",
                    "Cab Headroom Hero R Mic Type",
                    "Cab Signature 83 R Mic Type",
                ],
            },
            BlockSpec {
                id: "room-right",
    ...
    ModuleSpec {
        ...
        blocks: &[
            BlockSpec {
                id: "eq-comp-section",
                label: "EQ & Comp Section",
                block_type: BlockType::Special,
                exact: &["Active EQ & Comp Section"],
                prefixes: &[],
            },
            BlockSpec {
                id: "smooth-operator-eq",
                label: "Smooth Operator EQ",
                block_type: BlockType::Eq,
                exact: &[],
                prefixes: &["Smooth Operator EQ "],
            },
            BlockSpec {
                id: "smooth-operator-comp",
                label: "Smooth Operator Compressor",
                block_type: BlockType::Compressor,
                exact: &[],
                prefixes: &["Smooth Operator Compressor "],
            },
            BlockSpec {
                id: "headroom-hero-eq",
                label: "Headroom Hero EQ",
                block_type: BlockType::Eq,
                exact: &[],
                prefixes: &["Headroom Hero EQ "],
            },
            BlockSpec {
                id: "headroom-hero-comp",
                label: "Headroom Hero Compressor",
                block_type: BlockType::Compressor,
                exact: &[],
                prefixes: &["Headroom Hero Compressor "],
            },
            BlockSpec {
                id: "signature-83-eq",
                label: "Signature 83 EQ",
                block_type: BlockType::Eq,
                exact: &[],
                prefixes: &["Signature 83 EQ "],
            },
            BlockSpec {
                id: "signature-83-comp",
                label: "Signature 83 Compressor",
                block_type: BlockType::Compressor,
                exact: &[],
                prefixes: &["Signature 83 Compressor "],
            },
            BlockSpec {
                id: "three-in-one-eq",
                label: "Three-In-One EQ",
                block_type: BlockType::Eq,
                exact: &[],
                prefixes: &["Three-In-One EQ "],
            },
            BlockSpec {
                id: "three-in-one-comp",
                label: "Three-In-One Compressor",
                block_type: BlockType::Compressor,
                exact: &[],
                prefixes: &["Three-In-One Compressor "],
            },
        ],
    },
    ModuleSpec {
...
const MISHA_MODULES: &[ModuleSpec] = &[
    ...
    ModuleSpec {
        ...
        blocks: &[
            BlockSpec {
                id: "special-fx-section",
                label: "Special FX Section",
                block_type: BlockType::Special,
                exact: &["Active Special FX Section"],
                prefixes: &[],
            },
            BlockSpec {
                id: "laser",
    ...
    ModuleSpec {
        ...
        blocks: &[
            ...
            BlockSpec {
                id: "horizon-compressor",
                label: "Horizon Compressor",
                block_type: BlockType::Compressor,
                exact: &[],
                prefixes: &["Horizon Devices Compressor "],
            },
            BlockSpec {
                id: "tape-echo",
                label: "Tape Echo",
            ...
            BlockSpec {
                ...
                block_type: BlockType::Drive,
                exact: &[],
                prefixes: &["Horizon Devices Precision Drive "],
            },
            BlockSpec {
                id: "chaos",
                label: "Chaos",
...
const PETRUCCI_MODULES: &[ModuleSpec] = &[
    ...
    ModuleSpec {
        ...
        blocks: &[
            BlockSpec {
                id: "wah-comp-section",
                label: "Wah/Comp Section",
                block_type: BlockType::Special,
                exact: &["Active Wah Comp Section"],
                prefixes: &[],
            },
            BlockSpec {
                id: "wah",
    ...
    ModuleSpec {
        ...
        blocks: &[
            BlockSpec {
                ...
                label: "Amp Section",
                block_type: BlockType::Special,
                exact: &["Active Amp Section", "Amp Type"],
                prefixes: &[],
            },
            BlockSpec {
                id: "piezo-amp",
...
const RABEA_MODULES: &[ModuleSpec] = &[
    ...
    ModuleSpec {
        ...
        blocks: &[
            ...
            BlockSpec {
                id: "synth-amp",
                label: "Synth Amplifier",
                block_type: BlockType::Special,
                exact: &[],
                prefixes: &["Synth Amplifier "],
            },
            BlockSpec {
                id: "synth-osc-1",
                label: "Synth OSC 1",
            ...
            BlockSpec {
                ...
                block_type: BlockType::Special,
                exact: &[],
                prefixes: &["Synth Osc 2 "],
            },
            BlockSpec {
                id: "synth-osc-unison",
                label: "Synth OSC Unison",
                block_type: BlockType::Special,
                exact: &[],
                prefixes: &["Synth Osc Unison", "Synth Osc Unisons"],
            },
            BlockSpec {
                id: "synth-filter",
                label: "Synth Filter",
    ...
    ModuleSpec {
        ...
        blocks: &[
            ...
            BlockSpec {
                id: "twin-blade-comp",
                label: "Twin Blade Dual Compressor",
                block_type: BlockType::Compressor,
                exact: &[],
                prefixes: &["Twin Blade Dual Compressor "],
            },
            BlockSpec {
                id: "chaos-bed-octaver",
                label: "Chaos Bed Octaver",
                block_type: BlockType::Pitch,
                exact: &[],
                prefixes: &["Chaos Bed Octaver "],
            },
            BlockSpec {
                id: "colossus-fuzz",
                label: "Colossus Fuzz",
                block_type: BlockType::Drive,
                exact: &[],
                prefixes: &["Colossus Fuzz "],
            },
            BlockSpec {
                id: "paragon-overdrive",
                label: "Paragon Overdrive",
                block_type: BlockType::Drive,
                exact: &[],
                prefixes: &["Paragon Overdrive "],
            },
        ],
    },
    ModuleSpec {
...
const TIM_HENSON_MODULES: &[ModuleSpec] = &[
    ...
    ModuleSpec {
        ...
        blocks: &[
            ...
            BlockSpec {
                ...
                prefixes: &[
                    "Cab L ",
                    "Cherubs Amp Cab Mic L Type",
                    "Pink Amp Cab Mic L Type",
                ],
            },
            BlockSpec {
                id: "room-left",
            ...
            BlockSpec {
                ...
                prefixes: &[
                    "Cab R ",
                    "Cherubs Amp Cab Mic R Type",
                    "Pink Amp Cab Mic R Type",
                ],
            },
            BlockSpec {
                id: "room-right",
    ...
    ModuleSpec {
        ...
        blocks: &[
            BlockSpec {
                id: "multivoicer-section",
                label: "Multivoicer Section",
                block_type: BlockType::Special,
                exact: &["Active Multivoicer Section"],
                prefixes: &[],
            },
            BlockSpec {
                id: "multivoicer-global",
                label: "Multivoicer Global",
                block_type: BlockType::Pitch,
                exact: &[],
                prefixes: &[
                    "Multivoicer Tuning",
                    "Multivoicer Root",
                    "Multivoicer Mode",
                    "Multivoicer Quantize",
                    "Multivoicer Level Adder",
                    "Multivoicer Pan Multiplier",
                    "Multivoicer Detune Multiplier",
                    "Multivoicer Delay Multiplier",
                    "Multivoicer Unisons",
                    "Multivoicer Width",
                    "Multivoicer Tone",
                    "Multivoicer Output",
                    "Multivoicer Midi Enabled",
                    "Multivoicer DI Level",
                ],
            },
            BlockSpec {
                id: "multivoicer-v1",
                label: "Multivoicer Voice 1",
                block_type: BlockType::Pitch,
                exact: &[],
                prefixes: &["Multivoicer Voice 1 "],
            },
            BlockSpec {
                id: "multivoicer-v2",
                label: "Multivoicer Voice 2",
                block_type: BlockType::Pitch,
                exact: &[],
                prefixes: &["Multivoicer Voice 2 "],
            },
            BlockSpec {
                id: "multivoicer-v3",
                label: "Multivoicer Voice 3",
                block_type: BlockType::Pitch,
                exact: &[],
                prefixes: &["Multivoicer Voice 3 "],
            },
            BlockSpec {
                id: "multivoicer-v4",
                label: "Multivoicer Voice 4",
                block_type: BlockType::Pitch,
                exact: &[],
                prefixes: &["Multivoicer Voice 4 "],
            },
        ],
    },
    ModuleSpec {
