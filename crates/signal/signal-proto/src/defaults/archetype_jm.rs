    ...
    PluginBlockDef::new("Archetype: John Mayer X", 204)
        ...
        .with_module(
            VirtualModule::new("pedals", "Pedals", ModuleType::PreFx)
                .with_block(
                    VirtualBlock::new("justa-boost", "Justa Boost", BlockType::Boost).with_params(
                        vec![
                ...
                .with_block(
                    VirtualBlock::new("halfman-od", "Halfman OD", BlockType::Drive).with_params(
                        vec![
                ...
                .with_block(
                    VirtualBlock::new("tealbreaker", "Tealbreaker", BlockType::Drive).with_params(
                        vec![
        ...
        .with_module(
            VirtualModule::new("amp", "Amp", ModuleType::Amp).with_block(
                VirtualBlock::new("amp-block", "Amp", BlockType::Amp).with_params(vec![
        ...
        .with_module(
            VirtualModule::new("cab", "Cab", ModuleType::Amp).with_block(
                VirtualBlock::new("cab-block", "Cabinet", BlockType::Cabinet).with_params(vec![
        ...
        .with_module(VirtualModule::new("eq", "EQ", ModuleType::Eq).with_block(
            VirtualBlock::new("eq-block", "EQ", BlockType::Eq).with_params(vec![
        ...
        .with_module(
            VirtualModule::new("post-fx", "Post-FX", ModuleType::Time)
                .with_block(
                    VirtualBlock::new("dream-delay", "Dream Delay", BlockType::Delay).with_params(
                        vec![
                ...
                .with_block(
                    VirtualBlock::new("studio-verb", "Studio Verb", BlockType::Reverb).with_params(
                        vec![
