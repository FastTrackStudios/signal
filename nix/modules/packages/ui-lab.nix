...
# Its own pnpm workspace under apps/task/ui-lab (vendor/* holds the
# vendored @bearcove/vox-* TS runtime as workspace:* deps). Fetcher,
# config hook, and build pnpm MUST be the same major — pin all three
# to pnpm_9.
{ ... }:
{
