...
impl ProfileRig {
    ...
    /// What has been written to the playing chain since it was built —
    /// knobs, macros, the boost, the tempo, bypasses — by block id, oldest
    /// first, one per block and param. The chain plays its definition with
