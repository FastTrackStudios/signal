...
//!
//! Lives in `trigger-ui` because it depends on nice_plug; `fts-audio-ui`
//! itself is provider-agnostic. Same shape as `comp-ui::param_adapter` — use
//! this whenever you wire a Dioxus audio widget to a plugin parameter.
